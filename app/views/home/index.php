...
<div class="card-deck">
  <div class="card text-center">
    <img src="<?= BASEURL; ?>/img/hardcase.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Hardcase</h5>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    </div>
    <div class="card-footer">
      <small><a href="#" class="btn btn-primary">Go somewhere</a></small>
    </div>
  </div>
  <div class="card text-center">
  ...
  <div class="card text-center">
    <img src="<?= BASEURL; ?>/img/soft.jpg" class="card-img-top" alt="...">
    <div class="card-body">
      <h5 class="card-title">Softcase</h5>
      <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
    </div>
    <div class="card-footer">
        <small><a href="#" class="btn btn-primary">Go somewhere</a></small>
