...
<div class="accordion" id="accordionExample">
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
        Disini kamu bisa buat custom case dengan foto apapun
        mau pake foto sendiri,pacar,atau keluarga semua bisa 
        jika kamu gak ada desain bisa juga pake katalog desain kami.
      </div>
    </div>
  </div>
  <div class="card">
